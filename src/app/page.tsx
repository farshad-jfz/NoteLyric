  ...
  return (
    <Card withBorder radius="lg" shadow="xs">
      <Stack>
        ...
        <Text>Generate readable harmonica exercises for scales, chords/arpeggios, jazz practice, and sight-reading directly in your browser.</Text>
        <Group>
          ...
          <Button component={Link} href="/jazz" variant="light">
            Open Jazz Practice
          </Button>
